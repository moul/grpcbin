...
func init() {
	proto.RegisterType((*SumRequest)(nil), "addsvc.SumRequest")
	proto.RegisterType((*SumReply)(nil), "addsvc.SumReply")
	proto.RegisterType((*ConcatRequest)(nil), "addsvc.ConcatRequest")
	proto.RegisterType((*ConcatReply)(nil), "addsvc.ConcatReply")
}
...
func (c *addClient) Sum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumReply, error) {
	out := new(SumReply)
	err := grpc.Invoke(ctx, "/addsvc.Add/Sum", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addClient) Concat(ctx context.Context, in *ConcatRequest, opts ...grpc.CallOption) (*ConcatReply, error) {
	out := new(ConcatReply)
	err := grpc.Invoke(ctx, "/addsvc.Add/Concat", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	,
}
